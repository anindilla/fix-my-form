    ...
    <div className="min-h-screen bg-white">
          ...
          <section className="hero-gradient min-h-screen flex items-center justify-center relative overflow-hidden pt-20 pb-16">
            ...
            <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
              ...
              <p className="text-xl md:text-2xl text-gray-800 mb-16 max-w-3xl mx-auto leading-relaxed font-medium">
              ...
              Get personalized feedback on your workout form in three simple steps
                ...
                <div className="grid md:grid-cols-3 gap-12">
                  <div className="text-center group">
                    <div className="bg-blue-600 w-20 h-20 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg">
                      <svg className="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2.5}>
                        <path strokeLinecap="round" strokeLinejoin="round" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12" />
                      </svg>
                    </div>
                    <h3 className="text-2xl font-bold text-gray-900 mb-4">1. Upload Video</h3>
                  ...
                  <div className="text-center group">
                    ...
                    <h3 className="text-2xl font-bold text-gray-900 mb-4">3. Get Feedback</h3>
                    <p className="text-gray-600 text-lg leading-relaxed">
